...
const TeamMedia = () => {
  ...
  return (
    <div className="relative min-h-screen px-4 py-2 overflow-hidden">
      ...
      >
        <h1 className="m-2 text-4xl opacity-70 text-rose-500">
          Media Team
        </h1>
        <MemberList
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Videos (Embedded like Presentation) */}
          <div className="md:col-span-2 flex flex-col gap-4">

            {/* Recap */}
            <motion.div
              variants={cardReveal as any}
              className="group relative rounded-2xl overflow-hidden border border-white/5 bg-white/2 backdrop-blur-sm shadow-xl"
            >
              {/* Label */}
              <div className="absolute top-3 left-3 z-20">
              ...
              <div className="relative w-full aspect-video">
                <iframe
                  src={content.teamMedia.recapSrc.replace("/view", "/preview")}
            ...
            >
              ...
              <div className="relative w-full aspect-video">
                <iframe
                  src={content.teamMedia.trailerSrc.replace("/view", "/preview")}
                  className="absolute inset-0 w-full h-full"
                  allow="autoplay; fullscreen"
                />
              </div>
