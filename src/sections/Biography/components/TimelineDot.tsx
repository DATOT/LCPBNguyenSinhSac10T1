...
export default function TimelineDot({
  ...
  return (
    ...
    >
      {/* DOT */}
      <motion.div
        className="w-2 h-2 rounded-full bg-[rgb(var(--color-background-opposite))] z-10"
        animate={{
      ...
      <AnimatePresence>
        {emphasis !== "idle" && (
          <motion.div
            className="absolute left-4 top-1/2 -translate-y-1/2 whitespace-nowrap text-sm font-bold text-[rgb(var(--color-text))]/70"
